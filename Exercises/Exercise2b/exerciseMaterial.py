...
# The function used to convert a color image to a gray-scale image is cv2.cvtColor() with the flag cv2.COLOR_BGR2GRAY. This function takes a color image as input and returns a gray-scale version of the image.
