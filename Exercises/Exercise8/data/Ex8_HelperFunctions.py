#Har selv puttet code snippets fra data/readme.md ind i denne python-fil kaldet auxiliaryFuns
...
def align_and_crop_one_cat_to_destination_cat(img_src, lm_src, img_dst, lm_dst):
    ...
    :param img_src: Image average_cat_img = create_u_byte_image_from_vector(average_cat, height, width, channels)
fig, ax = plt.subplots(1, 1, figsize=(6, 6))
plt.imshow(average_cat_img)
ax.set_title("Mean cat")
ax.set_axis_off()
plt.show()of source cat
...
def preprocess_one_cat_MY_OWN_VERSION():
    src = "data/Mycat"
    dst = "data/MissingCat"
    out = "data/MyCatProcessed.jpg"
